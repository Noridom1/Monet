...
try:
    from run_scripts.evaluation.latent_activation import annotate_latent_response, latent_block_count
    from run_scripts.evaluation.secret_redaction import install_log_secret_redaction, redact_cli_secret
    from run_scripts.evaluation.summarize_table3 import DATASETS, write_reports
