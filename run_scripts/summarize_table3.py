...
This script is deliberately separate from ``04_run_eval.sh``: it only reads
...
try:
    from run_scripts.latent_activation import latent_block_count
except ModuleNotFoundError:  # Support ``python run_scripts/summarize_table3.py``.
